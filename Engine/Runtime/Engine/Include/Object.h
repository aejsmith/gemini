/*
 * Copyright (C) 2015-2018 Alex Smith
 *
...
/**
 * Object-specific wrapper for ReferencePtr. No functional difference between
 * the two, just to clarify intention and to allow for additional Object-
 * specific behaviour to be added later without having to change any other code.
 */
...
public:
    ...
    using ConstructorFunction     = ObjectPtr<> (*)();
...
private:
     ...
     */
    ObjectPtr<>                     ConstructPrivate() const;
